...
export default function ResetPasswordPage() {
  ...
  if (isReset) {
    return (
      <main className="min-h-screen bg-gradient-to-b from-black via-black to-theme-950/10 flex items-center justify-center p-4">
        <motion.div
        ...
        >
          <div className="glass rounded-2xl border border-theme/20 shadow-2xl shadow-theme/5 p-8">
            <div className="text-center py-4">
              ...
              <Link href="/" className="flex items-center justify-center gap-2 text-sm text-gray-400 hover:text-theme transition-colors mt-4">
        ...
        <div className="glass rounded-2xl border border-theme/20 shadow-2xl shadow-theme/5 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-white mt-4">
              Reset <span className="text-theme neon-glow">Password</span>
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-400 bg-theme/5 p-3 rounded-xl border border-theme/10">
