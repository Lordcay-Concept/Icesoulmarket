      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          <motion.div
            ...
            className="mb-6 inline-flex items-center gap-2 rounded-full glass px-4 py-2 text-sm text-emerald-400 border border-emerald-400/30"
          >
          ...
          <h1 className="mb-4 text-5xl font-bold md:text-7xl leading-tight">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href={slides[currentSlide].link}>
              <Button className="gaming-btn text-lg px-8 py-6 group">
                {slides[currentSlide].cta}
                <ChevronRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
              </Button>
            </Link>
            <Link href="/products">
              <Button variant="outline" className="border-emerald-400/30 text-white hover:bg-emerald-400/10 hover:border-emerald-400/50 transition-all">
                Browse All
              </Button>
            </Link>
          </div>
          ...
          >
            {[
              ...
              <div key={stat.label} className="glass rounded-lg px-6 py-3 border border-emerald-400/10">
                <div className="text-2xl font-bold text-emerald-400 neon-glow">{stat.value}</div>
          ...
          {slides.map((_, index) => (
            <button
              ...
              className={`h-2 rounded-full transition-all duration-300 ${
                index === currentSlide 
                  ? 'w-12 bg-gradient-to-r from-emerald-400 to-green-500 neon-glow' 
